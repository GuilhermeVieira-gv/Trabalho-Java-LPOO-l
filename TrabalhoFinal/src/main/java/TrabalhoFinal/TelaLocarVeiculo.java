 ...
 * @author nicol
 */
public class TelaLocarVeiculo extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLocarVeiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
